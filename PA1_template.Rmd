...
weekday_plot <- ggplot(weekday_time_group, aes(interval,Average.Steps))+geom_line(col="blue")+labs(title = "Average Daily Activity Summary", x = "5 Minute Intervals, Averaged Over All Days", y = "Average Number of Steps")
...
weekend_plot <- ggplot(weekend_time_group, aes(interval,Average.Steps))+geom_line(col="orange")+labs(title = "Average Daily Activity Summary", x = "5 Minute Intervals, Averaged Over All Days", y = "Average Number of Steps")
